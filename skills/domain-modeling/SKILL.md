...
Create files lazily — only when you have something to write. If no `CONTEXT.md` exists, create one when the first term is resolved (see [CONTEXT-FORMAT.md](./CONTEXT-FORMAT.md)). If no `docs/adr/` exists, create it when the first ADR is needed.
